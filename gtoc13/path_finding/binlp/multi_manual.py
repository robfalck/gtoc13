...
# ############### CONFIG 1 ###############
input_dict_1 = dict(Yo=30, Yf=90, perYear=0.5, bodies_data=bodies_data)
...
segment_1, flyby_history, seg_model_1 = run_segment_problem(pidxs_params_1, discrete_data_1, solv_params_1, dv_table_1)
