...
@timer
def grand_tour_vars_and_constrs(seq_model: pyo.ConcreteModel, bodies_list: list[int]):
    """
...
def prune_sequence(
    ...
    for h, entry in enumerate(pruned):
        seq_model.x_kih[entry, h + 1].fix(0)
