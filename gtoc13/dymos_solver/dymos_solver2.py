...
if __name__ == '__main__':
    ...
    prob = get_dymos_serial_solver_problem(bodies=[10, 7], num_nodes=20, warm_start=False, default_opt_prob=True)
    prob.setup()
    prob.set_val('dt', [20., 50.], units='gtoc_year')
    prob.run_driver()
